      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
          <Card>
            <div className="text-center">
              ...
              <p className="text-xl sm:text-3xl font-bold text-orange-600">{lowStock.totalAlerts || 0}</p>
            </div>
          </Card>
          <Card>
            <div className="text-center">
              <p className="text-xs sm:text-sm text-gray-500">Critical Alerts</p>
              <p className="text-xl sm:text-3xl font-bold text-red-600">{lowStock.criticalCount || 0}</p>
            </div>
          </Card>
          <Card>
            <div className="text-center">
              <p className="text-xs sm:text-sm text-gray-500">Dead Stock Items</p>
              <p className="text-xl sm:text-3xl font-bold text-gray-600">{deadStock.totalItems || 0}</p>
            </div>
          </Card>
          <Card>
            <div className="text-center">
              <p className="text-xs sm:text-sm text-gray-500">Value Blocked</p>
              <p className="text-xl sm:text-3xl font-bold text-purple-600">{formatCurrency(deadStock.totalValueBlocked || 0)}</p>
            </div>
          </Card>
        </div>
        ...
        <Card>
          <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4 sm:items-end">
            ...
            <Button variant="outline" onClick={() => setFilters({ warehouse: '', days: 30 })} className="w-full sm:w-auto">
              Clear
            </Button>
          </div>
        </Card>
